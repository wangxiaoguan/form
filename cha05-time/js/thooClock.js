    ...
    $.fn.thooClock = function (options) {
        this.each(function () {
            ...
            y = 0; function startClock(x, y) {
                ...
                var synced_delay = 1000 - ((new Date().getTime()) % 1000); setTimeout(function () { startClock(x, y); }, synced_delay);
            }
            startClock(x, y);
        });
    };
